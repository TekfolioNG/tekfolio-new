                    ...
                    <div class="order-1 lg:order-1">
                        ...
                        <div class="mb-8">
                            <div class="flex items-center gap-3 mb-3">
                                ...
                                <span class="text-sm font-semibold text-purple-700 uppercase tracking-wider">
                                    From Prototype to Web Development
                                </span>
                            </div>
                        ...
                        <div class="space-y-6 text-gray-900">
                            ...
                            <p class="text-base md:text-lg leading-relaxed">
                                At our website design company in Lagos, we develop custom applications built around your
                                exact
                            ...
                            <p class="text-base md:text-lg leading-relaxed">
                                <strong>The result?</strong> Fully and functionally built website that feels like it was
                                made for you ...And well,
