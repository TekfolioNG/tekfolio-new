    ...
    <div class="bg-white">
        ...
        <section class="relative w-full h-64 md:h-[400px] overflow-hidden">
            ...
            <div class="absolute inset-0">
                ...
                <picture>
                    <source :srcset="webHero" type="image/avif" />
                    <source :srcset="webHero.replace('.avif', '.webp')" type="image/webp" />
                    <img :src="webHero" alt="CaseStudies - Tekfolio"
...
onMounted(() => {
    ...
    checkImageCache(webHero, () => heroImageLoaded.value = true);
});
</script>
