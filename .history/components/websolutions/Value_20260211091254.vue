<template>
    <section ref="tekfolioEdgeSection" class="w-full bg-gray-100 py-20 lg:py-28 relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-8 sm:px-12 lg:px-16 relative z-10">
            ...
            <div class="text-center mb-12 lg:mb-16">
                <div class="mb-8">
                    <div class="flex items-center justify-center gap-3 mb-2">
                        <div class="h-px w-12 tekfolio-gradient"></div>
                        <span class="text-sm font-semibold uppercase tracking-wider tekfolio-text">The Tekfolio
                            Edge</span>
                        <div class="h-px w-12 tekfolio-gradient"></div>
                    </div>
                    <h2 class="text-2xl md:text-3xl lg:text-4xl font-semibold text-gray-900 leading-tight mb-4">
                        What Do Clients Get When They Build Web Apps with Us?
                    </h2>
                    <h3 class="text-xl md:text-2xl font-medium tekfolio-text">
            ...
            <div class="hidden lg:grid gap-8" style="grid-template-columns: 30% 35% 35%;">
                <!-- Left Column: Image (30%) -->
                <div class="flex items-center justify-center">
                    <div class="w-full">
                        <img src="/assets/img/next.png" alt="Web Design Illustration"
                            class="w-full h-auto floating-image" />
                    </div>
                </div>

                <!-- Middle Column: First 4 Cards (35%) -->
                <div class="space-y-5">
                    <div v-for="(feature, index) in features.slice(0, 4)" :key="feature.id"
                        ...
                        <button @click="toggleCard(index)"
                            ...
                            <!-- Icon Container -->
                            <div
                                class="shrink-0 w-12 h-12 rounded-xl tekfolio-gradient flex items-center justify-center shadow-lg group-hover:shadow-xl group-hover:scale-110 transition-all duration-300">
                            ...
                            <!-- Chevron -->
                            <div
                                class="shrink-0 w-9 h-9 rounded-full bg-gradient-to-br from-purple-100 to-blue-100 flex items-center justify-center group-hover:from-purple-200 group-hover:to-blue-200 transition-all duration-300">
            ...
            <div class="lg:hidden mb-8">
                <div class="max-w-md mx-auto">
                    <img src="~/assets/img/webdesignimg.png" alt="Web Design Illustration"
                        class="w-full h-auto floating-image" />
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 gap-5 lg:hidden">
                <div v-for="(feature, index) in features" :key="feature.id"
                    ...
                    <button @click="toggleCard(index)"
                        ...
                        <!-- Icon Container -->
                        <div
                            class="shrink-0 w-12 h-12 rounded-xl tekfolio-gradient flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300">
                            <component :is="feature.icon" class="w-6 h-6 text-white" :stroke-width="2.5" />
                        </div>
