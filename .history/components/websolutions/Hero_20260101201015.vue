    ...
    <div class="min-h-screen bg-white">
        ...
        <section class="relative w-full h-64 md:h-[400px] overflow-hidden">
            ...
            <div class="absolute inset-0">
                <picture>
                    <source :srcset="webHero.replace('.jpeg', '.avif')" type="image/avif" />
                    <source :srcset="webHero.replace('.jpeg', '.webp')" type="image/webp" />
                    <img :src="webHero" alt="CaseStudies - Tekfolio" class="w-full h-full object-cover sharp-image" />
                </picture>
            </div>
...
import webHero from '~/assets/img/webhero.jpeg';
</script>
