    ...
    <section
        ...
        <div class="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
                ...
                <div
                    class="text-center md:text-left group relative bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border border-gray-100">
                    <!-- Step Number Circle -->
                    <div
                        class="absolute -top-5 left-8 w-14 h-14 bg-linear-to-br from-purple-600 to-blue-600 rounded-full flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
