<template>
    <section
        class="py-20 sm:py-24 lg:py-32 bg-linear-to-br from-slate-50 via-white to-purple-50 relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
                ...
                <div
                    ...
                    <!-- Step Number Circle -->
                    <div
                        class="absolute -top-5 left-8 w-14 h-14 bg-linear-to-br from-purple-700 to-purple-900 rounded-full flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
