    ...
    <div class="min-h-screen bg-white">
        ...
        <section class="relative w-full h-64 md:h-[400px] overflow-hidden">
            ...
            <div class="absolute inset-0">
                <picture>
                    <source :srcset="mobileApps.replace('.jpeg', '.avif')" type="image/avif" />
                    <source :srcset="mobileApps.replace('.jpeg', '.webp')" type="image/webp" />
                    <img :src="mobileApps" alt="CaseStudies - Tekfolio"
...
import mobileApps from '~/assets/img/mobilehero.jpg';
