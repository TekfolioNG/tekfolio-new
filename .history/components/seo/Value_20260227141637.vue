            ...
            <div class="grid grid-cols-1 lg:grid-cols-[55%_45%] gap-6 items-center">
                ...
                <div class="order-1 lg:order-1">
                    <h2
                        ...
                        What You Get When You Hires Us for Digital Marketing and SEO
                    </h2>
                    ...
                    <p class="text-base md:text-lg leading-relaxed text-gray-700 text-center md:text-left">
                        As one of the leading digital marketing websites in Nigeria, we deliver SEO strategies that
                        combine technical precision, strategic content, and performance
                        optimization—engineered. The advanced but structured online marketing system we build and
                        execuite for your business will move your brand from page 5 to page 1 on SERPs, and organically
                        keep you
                        there as search
                        algorithms evolve.
...
<script setup>
import { Binoculars, BriefcaseBusiness, ChartSpline, Link, Microscope, MousePointerClick, Search, ShieldCheck } from 'lucide-vue-next';
