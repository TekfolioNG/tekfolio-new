                    ...
                    <div class="order-1 lg:order-1">
                        ...
                        <div class="space-y-6 text-gray-900">
                            ...
                            <p class="text-base md:text-lg leading-relaxed">
                                ...And that's the clear truth we start with when you engage us at Tekfolio for your SEO
                            ...
                            <p class="text-base md:text-lg leading-relaxed pt-2">
                                <strong class="text-purple-700">Ready to move from page 5 to page 1 on Google Search
                                    Results?</strong>
