    ...
    <div class="min-h-screen bg-white">
        ...
        <section class="relative w-full h-64 md:h-[400px] overflow-hidden">
            ...
            <div class="absolute inset-0">
                <picture>
                    <source :srcset="creativeHero.replace('.jpeg', '.avif')" type="image/avif" />
                    <source :srcset="creativeHero.replace('.jpeg', '.webp')" type="image/webp" />
                    <img :src="creativeHero" alt="CaseStudies - Tekfolio"
...
import creativeHero from '~/assets/img/creativehero.jpeg';
