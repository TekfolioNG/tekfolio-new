    ...
    <div class="bg-white">
        ...
        <section class="relative w-full h-64 md:h-[400px] overflow-hidden">
            ...
            <div class="absolute inset-0">
                ...
                <picture>
                    <source :srcset="creativeHero" type="image/avif" />
                    <source :srcset="creativeHero.replace('.avif', '.webp')" type="image/webp" />
                    <img :src="creativeHero" alt="Creative Coding - Tekfolio"
...
onMounted(() => {
    ...
    checkImageCache(creativeHero, () => heroImageLoaded.value = true);
});
</script>
