<template>
  <footer class="bg-gray-900 text-gray-300">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
      ...
      <!-- Top Section: Logo, Solutions, Company, and Contact (4 columns) -->
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-12">
        ...
        <div class="text-center md:text-left md:pl-8 md:-mr-4">
          ...
          <ul class="space-y-3">
            <li>
              <NuxtLink to="/web-solutions" class="text-gray-400 hover:text-white hover:underline transition-colors">
                AI Agents & Automation
              </NuxtLink>
            </li>
            <li>
              <NuxtLink to="/mobile-apps" class="text-gray-400 hover:text-white hover:underline transition-colors">
                Intelligent Web & Mobile Platforms
              </NuxtLink>
            </li>
        ...
        <div class="text-center md:text-left md:ml-4 ">
          ...
          <div class="space-y-3">
            <!-- Address -->
            <div class="space-y-1">
              <p class="text-gray-400 text-sm">77 Awolowo Road, MAN House</p>
              <p class="text-gray-400 text-sm">Ikeja, Lagos, Nigeria</p>
            </div>

            <!-- Phone -->
            <p class="text-gray-300">
              <span class="text-gray-500">Phone:</span>
              <a href="tel:+2347088547450"
      ...
      <!-- Bottom Section: Copyright, Legal Links, and Social -->
      <div class="border-t border-gray-800 pt-8">
        <div
          class="flex flex-col lg:flex-row lg:items-center lg:justify-between text-center lg:text-left space-y-6 lg:space-y-0">

          <!-- Copyright -->
          <div>
            <p class="text-gray-500 text-sm">
              © {{ currentYear }} Tekfolio. All rights reserved.
            </p>
            <p class="text-gray-500 text-sm mt-1">
              Proudly built in Nigeria, serving global clients.
            </p>
          </div>
          ...
          <!-- Social Links -->
          <div class="flex items-center justify-center space-x-6">
            <a href="https://web.facebook.com/tekfolio/ " target="_blank" rel="noopener noreferrer"
            ...
            <a href="https://www.linkedin.com/company/tekfolio-ng" target="_blank" rel="noopener noreferrer"
            ...
            <a href="https://x.com/tekfoliong" target="_blank" rel="noopener noreferrer"
            ...
            <a href="https://www.instagram.com/tekfoliong/ " target="_blank" rel="noopener noreferrer"
            ...
            <a href="https://www.youtube.com/@Tekfoliong " target="_blank" rel="noopener noreferrer"
