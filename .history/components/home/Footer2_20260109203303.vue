                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <p class="text-gray-400 text-sm mb-3">
                                Have an idea or early requirements, but not sure where to start? Schedule a focused call
                                to review
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <p class="text-gray-400 text-sm mb-3">
                                Ready to move forward? Share your requirements and receive a detailed proposal tailored
                                to your specific
                                needs and timeline.
                            </p>
                            <NuxtLink to="/contact"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-12">
                ...
                <div class="space-y-4 text-center md:text-left md:pl-4 md:-mr-8">
                    ...
                    <p class="text-gray-300 text-base leading-relaxed">
                        ...
                        We combine thoughtful design, clean engineering, and practical problem-solving to deliver
                        software that
                        scales.
                    </p>
                </div>
