    ...
    <div class="min-h-screen bg-white">
        ...
        <section ref="howWeWorkSection" class="w-full bg-gray-100 py-20 lg:py-28 relative overflow-hidden">
            ...
            <div class="max-w-7xl mx-auto px-8 sm:px-12 lg:px-16 relative z-10">
                ...
                <div class="hidden lg:grid lg:grid-cols-12 gap-8 mb-12">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div v-for="(step, index) in steps" :key="step.id" :class="['group bg-gray-800 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border border-gray-700 hover:scale-[1.02] card-glow',
                                ...
                                <button @click="toggleCard(index)"
                                    ...
                                    <!-- Icon -->
                                    <div
                                        class="flex-shrink-0 w-12 h-12 bg-gray-700/50 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                                        <component :is="step.icon" class="w-6 h-6 text-purple-400" />
                                    </div>
                                    ...
                                    <div class="chevron-glow-circle">
                                        <svg :class="['w-5 h-5 text-purple-300 transition-transform duration-300 flex-shrink-0',
                        ...
                        <button @click="toggleCard(index)"
                            ...
                            <div
                                ...
                                <component :is="step.icon"
                                    class="w-6 h-6 text-gradient-to-br from-purple-600 to-blue-600" />
                            </div>
                            ...
                            <!-- Chevron with enhanced glow -->
                            <div class="chevron-glow-circle">
                                <svg :class="['w-5 h-5 text-gradient-to-br from-purple-600 to-blue-600 transition-transform duration-300 flex-shrink-0',
                                    { 'rotate-180': openCards[index] }]" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M19 9l-7 7-7-7" />
                    ...
                    <div class="bg-gray-800 rounded-2xl p-8 lg:p-12 order-1">
                        ...
                        <div class="mb-12">
                            <div :class="['flex items-center gap-3 mb-4', { 'animate-slide-in-left': textVisible }]">
                                ...
                                <span
                                    class="text-sm font-semibold text-gradient-to-br from-purple-600 to-blue-600 uppercase tracking-wider">The
                                    Right
                                    Fit</span>
                            </div>
...
<script setup>
import { Code, Compass, Headphones, Palette, Rocket, Search } from 'lucide-vue-next';
...
.chevron-glow-circle {
    ...
    box-shadow: 0 0 0 0 rgba(51, 97, 234, 0.7);
