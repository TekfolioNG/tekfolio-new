                    ...
                    <div class="order-1 lg:order-1 text-center lg:text-left">
                        ...
                        <div class="mb-4">
                            <div class="inline-flex items-center gap-3 mb-4 mx-auto lg:mx-0">
                                <div
                                    class="w-3 h-3 bg-gradient-to-r from-purple-900/95 to-blue-900/95 border-purple-700/30 rounded-full">
                                </div>
                        ...
                        <div class="space-y-6 text-gray-900">
                            ...
                            <p class="text-lg leading-relaxed">
                                ...
                                clarity, long-term thinking, and engineering discipline over shortcuts and hype. We’re
                                here to help
                        ...
                        <div class="relative group">
                            ...
                            <div
                                ...
                                <picture>
                                    ...
                                    <img :src="whoWeAreo" alt="WhoWeAre - Tekfolio"
