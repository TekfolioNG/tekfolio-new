            ...
            <div class="relative z-10 h-full flex items-center justify-end">
                <div class="container mx-auto px-6 md:px-12">
                    <div class="max-w-[180px] md:max-w-md ml-auto">
                        ...
                        <div>
                            <h1 class="text-xl md:text-3xl lg:text-4xl font-bold text-gray-100 leading-tight">
                                Your Brand Vision
                            </h1>
                            <h2 class="text-xl md:text-3xl lg:text-4xl font-medium text-gray-300 leading-tight">
