                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
                    ...
                    <div class="bg-gray-800 rounded-2xl p-8 lg:p-12">
                        ...
                        <div class="mb-12">
                            <div class="flex items-center gap-3 mb-4">
                                <div class="h-px w-12 bg-gradient-to-r from-purple-700 to-blue-600"></div>
                                <span class="text-sm font-semibold text-purple-700 uppercase tracking-wider">The Right
                                    Fit</span>
                            </div>
                        ...
                        <!-- Content List -->
                        <div class="space-y-6">
                            <div class="flex items-start gap-4 animate-slide-in-left" style="animation-delay: 0ms;">
                                <div
                                    class="flex-shrink-0 w-2 h-2 bg-gradient-to-r from-purple-700 to-blue-600 rounded-full mt-2">
                                </div>
                                <p class="text-base leading-relaxed text-white">
                                    You care about <span class="font-bold">long-term value</span>, not just launch day
                                </p>
                            </div>
                            <div class="flex items-start gap-4 animate-slide-in-left" style="animation-delay: 100ms;">
                                <div
                                    class="flex-shrink-0 w-2 h-2 bg-gradient-to-r from-purple-700 to-blue-600 rounded-full mt-2">
                                </div>
                                <p class="text-base leading-relaxed text-white">
                            ...
                            <div class="flex items-start gap-4 animate-slide-in-left" style="animation-delay: 200ms;">
                                <div
                                    class="flex-shrink-0 w-2 h-2 bg-gradient-to-r from-purple-700 to-blue-600 rounded-full mt-2">
                                </div>
                                <p class="text-base leading-relaxed text-white">
                            ...
                            <div class="flex items-start gap-4 animate-slide-in-left" style="animation-delay: 300ms;">
                                <div
                                    class="flex-shrink-0 w-2 h-2 bg-gradient-to-r from-purple-700 to-blue-600 rounded-full mt-2">
                                </div>
                                <p class="text-base leading-relaxed text-white">
                            ...
                            <div class="flex items-start gap-4 animate-slide-in-left" style="animation-delay: 400ms;">
                                <div
                                    class="flex-shrink-0 w-2 h-2 bg-gradient-to-r from-purple-700 to-blue-600 rounded-full mt-2">
                                </div>
                                <p class="text-base leading-relaxed text-white">
