                ...
                <div class="hidden lg:grid lg:grid-cols-12 gap-8 mb-4">
                    ...
                    <div class="col-span-5">
                        ...
                        <div class="relative h-32 mt-8">
                            <img :src="discoveryIcon" alt="Discovery" class="absolute w-12 h-12 animate-float"
                                style="left: 5%; top: 0%; animation-delay: 0s;" />
                            <img :src="strategyIcon" alt="Strategy" class="absolute w-14 h-14 animate-float"
                                style="left: 30%; top: 20%; animation-delay: 0.5s;" />
                            <img :src="uiuxIcon" alt="UI/UX" class="absolute w-11 h-11 animate-float"
                                style="left: 55%; top: 5%; animation-delay: 1s;" />
                            <img :src="buildIcon" alt="Build" class="absolute w-13 h-13 animate-float"
                                style="left: 15%; top: 50%; animation-delay: 1.5s;" />
                            <img :src="launchIcon" alt="Launch" class="absolute w-12 h-12 animate-float"
                                style="left: 70%; top: 45%; animation-delay: 2s;" />
                        </div>
                    </div>

                    <!-- Right Column: All Cards (2/3 width) -->
                    <div class="col-span-7 mt-0 lg:mt-16">
                                ...
                                <button @click="toggleCard(index)"
                                    ...
                                    <div class="chevron-glow-circle">
                                        <svg :class="['w-5 h-5 transition-transform duration-300 flex-shrink-0',
                                            ...
                                            <defs>
                                                <linearGradient id="chevron-gradient" x1="0%" y1="0%" x2="100%"
                                                    y2="100%">
                                                    <stop offset="0%"
                        ...
                        <button @click="toggleCard(index)"
                            ...
                            <div class="chevron-glow-circle">
                                <svg :class="['w-5 h-5 transition-transform duration-300 flex-shrink-0',
                                    ...
                                    <defs>
                                        <linearGradient id="chevron-gradient-mobile" x1="0%" y1="0%" x2="100%"
                                            y2="100%">
...
import buildIcon from '~/assets/img/build.svg';
import discoveryIcon from '~/assets/img/discovery.svg';
...
import uiuxIcon from '~/assets/img/uiux.svg';
