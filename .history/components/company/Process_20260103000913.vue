        ...
        <section ref="howWeWorkSection" class="w-full bg-gray-100 py-20 lg:py-28 relative overflow-hidden">
            ...
            <div class="max-w-7xl mx-auto px-8 sm:px-12 lg:px-16 relative z-10">
                ...
                <div class="hidden lg:grid lg:grid-cols-2 gap-8 mb-8">
                    ...
                    <div class="mt-20">
                        <div :class="['group bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border border-gray-200 hover:scale-[1.02]',
                            { 'animate-slide-up': cardsVisible }]" style="animation-delay: 0ms;">
                            ...
                            <button @click="toggleCard(steps[0].id)"
                                ...
                                <svg :class="['w-5 h-5 text-gray-500 transition-transform duration-300 flex-shrink-0',
                                    { 'rotate-180': openCards.has(steps[0].id) }]" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor">
                            ...
                            <div :class="['overflow-hidden transition-all duration-300 ease-in-out',
                                openCards.has(steps[0].id) ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0']">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-6">
                    ...
                    <template v-if="windowWidth < 1024">
                        <div v-for="(step, index) in steps" :key="step.id" :class="['group bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border border-gray-200 hover:scale-[1.02]',
                            ...
                            <button @click="toggleCard(step.id)"
                                ...
                                <!-- Chevron -->
                                <svg :class="['w-5 h-5 text-gray-500 transition-transform duration-300 flex-shrink-0',
                                    { 'rotate-180': openCards.has(step.id) }]" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M19 9l-7 7-7-7" />
                                </svg>
                            ...
                            <!-- Card Content - Expandable -->
                            <div :class="['overflow-hidden transition-all duration-300 ease-in-out',
                                openCards.has(step.id) ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0']">
                                <div class="px-6 pb-6 border-t border-gray-100 pt-4">
                                    <p class="text-base leading-relaxed text-gray-600">
                                        {{ step.description }}
                                    </p>
                    ...
                    <template v-else>
                        <div v-for="(step, index) in steps.slice(1)" :key="step.id" :class="['group bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border border-gray-200 hover:scale-[1.02]',
            ...
            <div class="max-w-7xl mx-auto px-8 sm:px-12 lg:px-16 relative z-10">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
                    ...
                    <div class="bg-gray-800 rounded-2xl p-8 lg:p-12">
                        ...
                        <!-- Content List with Decorative Bullets -->
                        <div class="space-y-6">
                            <div :class="['flex items-start gap-4', { 'animate-slide-in-left': textVisible }]"
                                ...
                                <div class="flex-shrink-0 mt-1.5">
                                    <svg class="w-5 h-5" viewBox="0 0 20 20" fill="none"
                                        ...
                                        <circle cx="10" cy="10" r="8" fill="url(#gradient1)" opacity="0.2" />
                            ...
                            <div :class="['flex items-start gap-4', { 'animate-slide-in-left': textVisible }]"
                                ...
                                <div class="flex-shrink-0 mt-1.5">
                                    <svg class="w-5 h-5" viewBox="0 0 20 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <circle cx="10" cy="10" r="8" fill="url(#gradient2)" opacity="0.2" />
                                        <circle cx="10" cy="10" r="5" fill="url(#gradient2)" />
                                        <defs>
                                            <linearGradient id="gradient2" x1="0" y1="0" x2="20" y2="20">
                                                <stop offset="0%" stop-color="#7c3aed" />
                                                <stop offset="100%" stop-color="#2563eb" />
                                            </linearGradient>
                                        </defs>
                            ...
                            <div :class="['flex items-start gap-4', { 'animate-slide-in-left': textVisible }]"
                                ...
                                <div class="flex-shrink-0 mt-1.5">
                                    <svg class="w-5 h-5" viewBox="0 0 20 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <circle cx="10" cy="10" r="8" fill="url(#gradient3)" opacity="0.2" />
                                        <circle cx="10" cy="10" r="5" fill="url(#gradient3)" />
                                        <defs>
                            ...
                            <div :class="['flex items-start gap-4', { 'animate-slide-in-left': textVisible }]"
                                ...
                                <div class="flex-shrink-0 mt-1.5">
                                    <svg class="w-5 h-5" viewBox="0 0 20 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <circle cx="10" cy="10" r="8" fill="url(#gradient4)" opacity="0.2" />
                                        <circle cx="10" cy="10" r="5" fill="url(#gradient4)" />
                                        <defs>
                                            <linearGradient id="gradient4" x1="0" y1="0" x2="20" y2="20">
                                                <stop offset="0%" stop-color="#7c3aed" />
                                                <stop offset="100%" stop-color="#2563eb" />
                                            </linearGradient>
                                        </defs>
                            ...
                            <div :class="['flex items-start gap-4', { 'animate-slide-in-left': textVisible }]"
                                ...
                                <div class="flex-shrink-0 mt-1.5">
                                    <svg class="w-5 h-5" viewBox="0 0 20 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <circle cx="10" cy="10" r="8" fill="url(#gradient5)" opacity="0.2" />
                                        <circle cx="10" cy="10" r="5" fill="url(#gradient5)" />
                                        <defs>
                                            <linearGradient id="gradient5" x1="0" y1="0" x2="20" y2="20">
                                                <stop offset="0%" stop-color="#7c3aed" />
                                                <stop offset="100%" stop-color="#2563eb" />
                                            </linearGradient>
                                        </defs>
                    ...
                    <div class="hidden lg:block">
                        <div class="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-12 shadow-sm">
                            <img :src="howWeWork" alt="Tekfolio How We Work" class="w-full h-auto scale-110" />
                        </div>
                    </div>
                </div>
            </div>
...
const toggleCard = (id) => {
    const newOpenCards = new Set(openCards.value);
