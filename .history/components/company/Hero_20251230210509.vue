    ...
    <div class="min-h-screen bg-white">
        ...
        <section class="relative w-full h-80 md:h-[400px] overflow-hidden">
            ...
            <div class="absolute inset-0">
                <img :src="companyHero" alt="About Us - Tekfolio" class="w-full h-full object-cover sharp-image" />
            </div>
                ...
                <div class="container mx-auto px-6 md:px-12">
                    <div class="max-w-[180px] md:max-w-md ml-auto">
                        ...
                        <div class="relative bg-gradient-to-br from-white/80 to-gray-50/75 backdrop-blur-sm p-4 md:p-8 shadow-2xl"
                            ...
                            <h1
                                class="text-xl md:text-3xl lg:text-4xl font-bold text-gray-900 leading-tight mb-2 md:mb-3">
                                Your Brand Vision
                            </h1>
                            <h2
                                class="text-xl md:text-3xl lg:text-4xl font-medium text-gray-900 leading-tight mb-2 md:mb-3">
