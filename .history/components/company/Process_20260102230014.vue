<template>
    <div class="min-h-screen bg-white">
        <!-- How We Work Section -->
        <section class="w-full bg-gray-50 py-20 lg:py-28 relative overflow-hidden">
            ...
            <div class="max-w-7xl mx-auto px-8 sm:px-12 lg:px-16 relative z-10">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    ...
                    <template v-else>
                        <div v-for="step in steps.slice(1)" :key="step.id"
                            class="group bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border border-gray-200 hover:scale-[1.02]">
                            <!-- Card Header - Clickable -->
                            <button @click="toggleCard(step.id)"
                                class="w-full p-6 flex items-center gap-4 hover:bg-gray-50 transition-colors duration-200 text-left">
            ...
            <div class="max-w-7xl mx-auto px-8 sm:px-12 lg:px-16 relative z-10">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
                    ...
                    <div>
                        ...
                        <div class="mb-12">
                            <div class="flex items-center gap-3 mb-4">
                                <div class="h-px w-12 bg-gradient-to-r from-blue-600 to-gray-400"></div>
                                <span class="text-sm font-semibold text-blue-600 uppercase tracking-wider">The Right
                                    Fit</span>
                            </div>
                            <h2 class="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 leading-tight mb-6">
...
const steps = [
    {
        ...
        title: "Discovery",
        icon: Search,
        preview: "We begin by listening. Understanding your goals, users, and constraints...",
        fullText: "before writing a single line of code ensures every decision is intentional and grounded in real needs."
    },
    {
        id: 2,
        title: "Strategy",
        icon: Compass,
        preview: "We map out the path forward with clear milestones and timelines...",
        fullText: "and the right technical approach. Early planning and visual direction keep decisions focused and aligned."
    },
    {
        id: 3,
        title: "Prototyping & UI/UX",
        icon: Palette,
        preview: "Ideas come to life through interactive prototypes...",
        fullText: "You can review, test, and refine the experience early, reducing guesswork and costly changes later."
    },
    {
        id: 4,
        title: "Build",
        icon: Code,
        preview: "Development happens in clear stages, with regular updates...",
        fullText: "and shared progress. Clean code, performance best practices, and scalable architecture are standard."
    },
    {
        id: 5,
        title: "Launch & Grow",
        icon: Rocket,
        preview: "We deploy with confidence, monitor performance...",
        fullText: "and support ongoing improvements. Your product remains stable, secure, and ready to evolve as your needs change."
    }
];
