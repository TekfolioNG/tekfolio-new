<template>
    <div class="min-h-screen bg-white">
        ...
        <section class="relative w-full h-72 md:h-[400px] overflow-hidden">
                ...
                <div class="container mx-auto px-6 md:px-12">
                    <div class="max-w-[180px] md:max-w-md ml-auto">
                        ...
                        <div class="relative bg-gradient-to-br from-white/80 to-gray-50/75 backdrop-blur-sm p-4 md:p-8 shadow-2xl"
                            ...
                            <h1
                                class="text-xl md:text-3xl lg:text-4xl font-bold text-gray-900 leading-tight mb-1 md:mb-2">
                                Your Brand Vision
                            </h1>
                            <h2 class="text-xl md:text-3xl lg:text-4xl font-medium text-gray-900 leading-tight">
