<template>
    <section ref="howWeWorkSection" class="w-full bg-gray-100 py-20 lg:py-28 relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-8 sm:px-12 lg:px-16 relative z-10">
            ...
            <div class="hidden lg:grid gap-10" style="grid-template-columns: 45% 55%;">
                <!-- Left Column: Images -->
                    ...
                    <div class="grid grid-cols-1 gap-5">
                        <div v-for="(step, index) in steps.slice(0, 5)" :key="step.id" :class="['group rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden border border-purple-200/50 hover:border-purple-400/70 hover:-translate-y-1 card-container',
                            ...
                            <button @click="toggleCard(index)"
                                ...
                                <!-- Icon Container -->
                                <div
                                    class="shrink-0 w-14 h-14 rounded-xl bg-linear-to-br from-purple-600 to-blue-600 flex items-center justify-center shadow-lg group-hover:shadow-xl group-hover:scale-110 transition-all duration-300">
                                ...
                                <!-- Chevron -->
                                <div
                                    class="shrink-0 w-10 h-10 rounded-full bg-linear-to-br from-purple-100 to-blue-100 flex items-center justify-center group-hover:from-purple-200 group-hover:to-blue-200 transition-all duration-300">
            ...
            <div class="grid grid-cols-1 gap-5 lg:hidden mb-8">
                <div v-for="(step, index) in steps.slice(0, 5)" :key="step.id" :class="['group rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden border border-purple-200/50 hover:border-purple-400/70 card-container',
                    ...
                    <button @click="toggleCard(index)"
                        ...
                        <!-- Icon Container -->
                        <div
                            class="shrink-0 w-12 h-12 rounded-xl bg-linear-to-br from-purple-600 to-blue-600 flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300">
...
import prototypeImage from '~/assets/img/teamwork.png';
...
const steps = [
    ...
    },
    {
        ...
        icon: Compass,
        description: "With that clarity in place, we next map out the path forward, setting clear milestones and timelines that fit perfectly into your business goals, as well as the right technical approach. Early planning and visual direction keep decisions focused and aligned."
    },
    {
        id: 3,
        title: "Prototyping & UI/UX",
        icon: Palette,
        description: "Ideas then move into visual form through wireframes and interactive prototypes using tools such as Figma, Adobe XD, and proven diagramming platforms. You can review, test, and refine the experience early, reducing guesswork and ensuring refinement before development begins."
    },
    {
        id: 4,
        title: "Build & Visualization",
        icon: Code,
        description: "Once the direction is validated, development progresses in clear stages with regular updates and shared visibility. We deploy modern frameworks such as Next, Nuxt JS, or Flutter, along with reliable backend technologies like Node JS and databases, while data analysis and visualisation draw on tools like Pandas, Tableau, Power BI, and R libraries including ggplot2 and dplyr. Clean code, performance best practices, and scalable architecture remain standard throughout."
    },
    {
        id: 5,
        title: "Launch & Grow",
