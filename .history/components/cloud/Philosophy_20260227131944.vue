                    ...
                    <div class="order-1 lg:order-1">
                        ...
                        <div class="space-y-6 text-gray-900">
                            <p class="text-base md:text-lg leading-relaxed font-medium text-gray-900">
                                Most organizations in Africa are sitting on a goldmine of untapped data...
                            ...
                            <p class="text-base md:text-lg leading-relaxed">
                                <strong>What you get is</strong> accurate data analysis. Clear insights. Faster, smarter
                                decisions.
