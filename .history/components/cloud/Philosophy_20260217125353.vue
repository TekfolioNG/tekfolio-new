                    ...
                    <div class="order-1 lg:order-1">
                        ...
                        <div class="space-y-6 text-gray-900">
                            ...
                            <p class="text-base md:text-lg leading-relaxed">
                                ...
                                reliable insights and help help organizations see what’s happening, understand why it’s
                            ...
                            <p class="text-base md:text-lg leading-relaxed pt-2">
                                <strong class="text-purple-700">Ready to make your business data work for you?</strong>
                                Let's talk.
