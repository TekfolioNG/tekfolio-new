            ...
            <div class="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-start">
                ...
                <div class="lg:col-span-3 order-2 lg:order-1">
                    ...
                    <div class="mb-8">
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <span class="text-sm font-semibold text-purple-700 uppercase tracking-wider">Get In
                                Touch</span>
                        </div>
                        ...
                        <p class="text-lg leading-relaxed text-gray-600 mb-8">
                            Whether you're starting fresh or rethinking an existing system, we're here to help you make
                            the right decisions from day one.
                        </p>
                        ...
                        <div class="space-y-4 mb-10">
                            <div class="flex items-start gap-3">
                                ...
                                <p class="text-base text-gray-700">
                                    <span class="font-bold">No pressure.</span> Just a conversation about what you're
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <p class="text-base text-gray-700">
                                    <span class="font-bold">No templates.</span> Every project gets the attention and
                                    strategic thinking it deserves.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="lg:col-span-2 order-1 lg:order-2">
                    <div class="sticky top-24">
                        <img src="../assets/img/contactform.svg" alt="Contact Tekfolio" class="w-full h-auto" />
                    </div>
                </div>
...
import contactFormImage from '../assets/img/contactform.svg';
