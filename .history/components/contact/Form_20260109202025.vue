            ...
            <div class="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-start">
                ...
                <div class="lg:col-span-3 order-1 lg:order-1">
                    ...
                    <form @submit.prevent="submitForm"
                        class="bg-gradient-to-r from-purple-800 to-blue-700 rounded-2xl shadow-lg p-8 md:p-10 border border-gray-300">
                        ...
                        <div class="grid md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="name" name="name" v-model="formData.name" required
                                    class="w-full px-4 py-3 bg-gradient-to-r from-purple-200 to-blue-100 border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-600 focus:border-transparent transition-all duration-300"
