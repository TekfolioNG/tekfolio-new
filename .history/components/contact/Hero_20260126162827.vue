<template>
    ...
    <section class="relative w-full h-64 md:h-[400px] overflow-hidden">
        ...
        <div class="absolute inset-0">
            ...
            <picture>
                <source :srcset="contactHero" type="image/avif" />
                <source :srcset="contactHero.replace('.avif', '.webp')" type="image/webp" />
                <img :src="contactHero" alt="Contact Us - Tekfolio"
...
import contactHero from '~/assets/img/contacthero.avif';
...
onMounted(() => {
    ...
    checkImageCache(contactHero, () => heroImageLoaded.value = true);
});
</script>
<style scoped>
