    ...
    <div class="bg-white">
        ...
        <section class="relative w-full h-64 md:h-[400px] overflow-hidden">
            ...
            <div class="absolute inset-0">
                ...
                <picture>
                    <source :srcset="careerHero" type="image/avif" />
                    <source :srcset="careerHero.replace('.avif', '.webp')" type="image/webp" />
                    <img :src="careerHero" alt="Careers - Tekfolio"
...
onMounted(() => {
    ...
    checkImageCache(careerHero, () => heroImageLoaded.value = true);
});
</script>
